...
import { dinningOutData } from './dinningOutData'
import "./dinning_out.css"
...
const diningList = dinningOutData;
...
const DinningOut = () => {
  return (
    <div>
      ...
      <ExploreSection list={diningList} collectionName="Dine-Out restraunts in Bangalore"/>
    </div>
  )
}
